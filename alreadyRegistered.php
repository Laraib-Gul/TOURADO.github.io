												...
												<nav class="main_nav">
													<ul
														...
														<li  data-toggle="modal" data-target="#myModal1"><a
																href="#">LogIn</a></li>
														<li class="active" data-toggle="modal" data-target="#myModal2"><a
																href="#">SignUp</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title bg-danger">Alert</div>
						</div>
					</div>
				</div>
			</div>
        ...
        <div class="container">
            ...
            <div class="card" style=" margin-top: 14%;">
                <div class="card-body text-center">
                    <p class="card-text" style="color: red; "><b>Sorry!</b> Someone is already <b>Registered</b> with the provided Email Address.<br>
                    Click to go back & <b>SignUp</b> with new Email Address. &nbsp;&nbsp; <a href="index.php" class="btn btn-info" style="background-color: rgb(154, 218, 165); color: black; border-color: rgb(154, 218, 165);">Go Back</a>
                   </p>
