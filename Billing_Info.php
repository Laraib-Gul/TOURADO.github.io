                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 contact_col">
                        <div class="info_form_container" style="width: 240%; margin-left: 150px;">
                            ...
                            $query = "SELECT pkg.*, bkp.puname, bkp.puemail, bkp.puphone,bkp.pucnic,bkp.puaddress, bkp.pkgid From packages pkg, book_package bkp where pkg.pkgID = bkp.pkgid ORDER BY puid DESC LIMIT 1 ";
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $row) { ?>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>User-Name: </b><?= $row['puname']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>CNIC: </b> <?= $row['pucnic']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Email Address: </b> <?= $row['puemail']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Ph No: </b> <?= $row['puphone']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Address: </b> <?= $row['puaddress']; ?></p>
                                    </div>
                                    <br>


                                        <div style="width: 50%;" class="centerdiv">
                                            <p class="one"><b>Package id: </b> <?= $row['pkgid']; ?></p>
                                        </div>
                                        <br>
                                        <div style="width: 50%;" class="centerdiv">
                                <p class="one"><b>Package Name: </b><?= $row['pkgName']; ?></p>
                            </div>
                            <br>
                            <div style="width: 50%;" class="centerdiv">
                                <p class="one"><b>Departure Date: </b><?= $row['pkgSDate']; ?></p>
                            </div>
                            <br>
                            <div style="width: 50%;" class="centerdiv">
                                <p class="one"><b>Arrival Date: </b><?= $row['pkgEDate']; ?></p>
                            </div>
                            <br>
                            <div style="width: 50%;" class="centerdiv">
                                <p class="one"><b>Days: </b><?= $row['pkgDays']; ?></p>
                            </div>
                            <br>
                            <div style="width: 50%;" class="centerdiv">
                                <p class="two"><b>Total Bill: </b><b style="color: rgb(248, 12, 12); size: 15px;"> </b><?= $row['pkgPrice']; ?></p>
                            </div>
                            <br>
                                <?php
