                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $row) { ?>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>User-Name: </b><?= $row['username']; ?></p>
                                    </div>
                                    <br>

                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Email Address: </b> <?= $row['email']; ?></p>
                                    </div>
                                    <br>
                                    ...
                                    <?php
                                    $tm = "SELECT * From historicalareas   ORDER BY hid  LIMIT 1 ";
                                    $tm_run = mysqli_query($conn, $tm);
                                    if (mysqli_num_rows($tm_run) > 0) {
                                        foreach ($tm_run as $row) { ?>
                                           <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>City: </b><?= $row['hcity']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Hotel: </b><?= $row['hhotel']; ?> </p>
                                    </div>
                                    <br>
                                   
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Days: </b> <?= $row['hdays']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Restaurant: </b><?= $row['hrest']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Area: </b> <?= $row['hareas']; ?></p>
                                    </div>
                                    <br>
                                    <div style="width: 50%;" class="centerdiv">
                                        <p class="one"><b>Transport: </b> <?= $row['htransport']; ?></p>
                                    </div>
                                    <br>
                                            <div style="width: 50%;" class="centerdiv">
                                                <p class="two"><b>Total Price: </b> <?= $row['hprice']; ?></p>
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <a href="Swat-KalamSchedul.html" class="btn"> Book Now </a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    ?> <a href="SkarduSchedule.html" class="btn"> Book Now </a>
                </div>
            </div>
